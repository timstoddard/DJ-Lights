// modified from https://github.com/ernieyu/Swing-range-slider/blob/master/src/slider/RangeSliderUI.java

package styles.strobe.rangeslider;
...
public class RangeSliderUI extends BasicSliderUI {
    ...
    /**
     * Returns a Shape representing the lower thumb.
     */
    private Shape createLowerThumbShape(int w, int h) {
        Polygon shape = new Polygon(new int[]{0, 0, w}, new int[]{h, 0, h / 2}, 3);
        return shape;
    }
    
    /**
     * Returns a Shape representing the upper thumb.
     */
    private Shape createUpperThumbShape(int w, int h) {
    	Polygon shape = new Polygon(new int[]{0, w, w}, new int[]{h / 2, 0, h}, 3);
    	return shape;
    }
